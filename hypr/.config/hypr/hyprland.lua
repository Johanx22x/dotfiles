...
-- above. Generated by the `hypr-monitor` script into ~/.config/hypr, which is
...
-- `hypr-tweak` script into ~/.config/hypr/tweaks.lua, which is untracked and
...
-- `hypr-monitor` script and owned by the settings window, which rewrites it
